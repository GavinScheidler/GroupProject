 ...
 */
 ...
 public class NUM50 {
        /**
     * The main method that demonstrates the impact of type conversion on arithmetic operations.
     * It shows how integer division can result in truncation and how casting to double can fix this issue.
     */
    public static void main(String[] args) {
        int a = 5;
        int b = 2;
        
        // Integer division: Since both 'a' and 'b' are integers, the result will be an integer.
        double resultNoConvert = a / b; // This will be 2 instead of 2.5 due to integer division.

        // Explicit type conversion: Casting 'a' to double ensures floating-point division.
