...
public class main {
    ...
    // Declare static objects for handling input, database, user and transaction
    // operations
     ...
     * 
     * @return true if login or user creation was successful, false if user chose to
     *         exit
     */
    ...
    public static void cleanup() {
        ...
        // Close any resources that need to be cleaned up (e.g., file readers/writers,
     ...
     * Continuously prompts for login or user creation until the user decides to
     * exit.
     */
